...
export const salaryAPI = {
  ...
  getWeeklyPayroll: (params) =>
    api.get('/salary/payroll/weekly', { params }),
...
export const weeklyWageAPI = {
  ...
  update: (id, data) =>
    api.put(`/weekly-wages/${id}`, data),
  delete: (id) =>
    api.delete(`/weekly-wages/${id}`),
  calculate: (data) =>
    api.post('/weekly-wages/calculate', data),
}
...
export const reportAPI = {
  ...
  fabric: (params) =>
    api.get('/reports/fabric', { params }),
  waste: (params) =>
    api.get('/reports/waste', { params }),
  allocation: (params) =>
...
export const dailyUsageAPI = {
  getAll: (params) =>
    api.get('/daily-usage', { params }),
  create: (data) =>
    api.post('/daily-usage', data),
  update: (id, data) =>
    api.put(`/daily-usage/${id}`, data),
  delete: (id) =>
    api.delete(`/daily-usage/${id}`),
  getReductionHistory: (params) =>
    api.get('/daily-usage/reduction-history', { params }),
  getWarnings: () =>
    api.get('/daily-usage/warnings'),
  getRawStock: () =>
    api.get('/daily-usage/raw-stock'),
  updateRawStock: (data) =>
    api.post('/daily-usage/raw-stock', data),
}
...
export const attendanceHistoryAPI = {
  ...
  getMonthly: (params) =>
    api.get('/attendance-history/monthly', { params }),
}
...
export const operationsAPI = {
  workAssign: (data) =>
    api.post('/work/assign', data),
  wagesCalculate: (data) =>
    api.post('/wages/calculate', data),
}